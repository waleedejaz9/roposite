...
const MinorProjectForm = () => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <div className="grid grid-cols-1 pr-10 pl-10 md:grid-cols-3 sm:grid-cols-2 p-4 gap-x-6 w-full">
      ...
      <div className="grid grid-rows-10">
        ...
        <div className="flex flex-row p-3">
          ...
          <RadioQuestionAnswer
            ...
            onChange={formik.handleChange}
            options={qustionAnswerOptions}
            text="Is the landscaping on in the front yard proposed to be redone, either in full or in part?"
          />
        </div>
        <div className="flex flex-row p-3">
          ...
          <RadioQuestionAnswer
            ...
            onChange={formik.handleChange}
            options={qustionAnswerOptions}
            text="Is a retaining wall proposed to be built in the front yard?"
          />
        </div>
        <div className="flex flex-row p-3">
          <h1 className="flex justify-center pl-10"></h1>
          <RadioQuestionAnswer
            ...
            onChange={formik.handleChange}
            options={qustionAnswerOptions}
            text="If yes, is the porpes retaining wall entirelty withing the porperty line and is the height if the proposed retaining wall, including any aoointment(s) such as lanterns, lights, decorations, etc., at or below a maximum of 2ft. high?"
          />
        </div>
        <div className="flex flex-row p-3">
          ...
          <RadioQuestionAnswer
            ...
            onChange={formik.handleChange}
            options={qustionAnswerOptions}
            text="Is the total hardscape for the property being affected?"
          />
        </div>
        <div className="flex flex-row p-3">
          <h1 className="flex justify-center pl-10"></h1>
          <RadioQuestionAnswer
            ...
            onChange={formik.handleChange}
            options={qustionAnswerOptions}
            text="If yes, what is the total actual hardscape square footage proposed for this property? (see Policies for inclusions) What is the allowable impermeable square footage? (see Policies for calculation; ROPO can assist with this number)"
          />
        </div>
        <div className="flex flex-row p-3">
